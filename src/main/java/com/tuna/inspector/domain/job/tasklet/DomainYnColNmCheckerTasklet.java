...
@Slf4j
@Component
public class DomainYnColNmCheckerTasklet extends AbstractDomainYnTasklet {

    public DomainYnColNmCheckerTasklet(ColumnInfoMapper columnInfoMapper) {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        List<TargetInfo> targetInfoList = columnInfoMapper.targetInfoList1(dbSeq);
        for(TargetInfo targetInfo : targetInfoList){
            ...
            scoreInfo.setStep1Score(30);
            map.put(key,scoreInfo);
            log.info("step1 key: {},scoreinfo: {}",targetInfo,scoreInfo.toString());
        }
